...
const categories = [
  ...
  },
  {
    ...
    emoji: "📷",
    count: "6 Products",
    desc: "Mirrorless and DSLR cameras for photography and video.",
    ...
    <section id="categories" className="container py-16">
      <div className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-3xl text-gray-600 dark:text-gray-400">
          Browse products across multiple categories with AI-powered reviews,
          expert recommendations, price tracking and genuine user experiences.
        </p>
      </div>
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {categories.map((category) => (
          ...
          >
            <div className={`absolute inset-x-0 top-0 h-2 bg-gradient-to-r ${category.color}`} />
      ...
      <div className="mt-16 rounded-3xl bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 p-10 text-center text-white shadow-xl">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-blue-100">
          Use our AI Decision Engine to compare products, analyse expert
          opinions, read verified reviews and discover whether you should
          Buy, Wait or Avoid.
        </p>
