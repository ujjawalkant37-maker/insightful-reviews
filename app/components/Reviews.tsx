  ...
  return (
    <section className="mt-12 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <Link
          href={`/write-review?productId=${encodeURIComponent(productId)}`}
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-4">
        <div className="rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-600 p-6 text-white">
          ...
          <div className="mt-2 text-indigo-100">Average Rating</div>
          ...
          <div className="mt-6 border-t border-white/20 pt-6">
            ...
            <div className="text-indigo-100">Total Reviews</div>
          </div>
        </div>

        <div className="lg:col-span-3">
          <div className="mb-8 flex items-center justify-between">
            <div className="font-semibold">{reviews.length} Reviews</div>
          ...
          {loading ? (
            <div className="py-16 text-center">Loading Reviews...</div>
          ) : reviews.length === 0 ? (
            <div className="rounded-2xl border border-dashed p-12 text-center">
              <div className="text-6xl">⭐</div>
              <h3 className="mt-4 text-2xl font-bold">No Reviews Yet</h3>
