        ...
        <div className="container mx-auto px-4 py-16">
          <div className="mx-auto max-w-2xl rounded-3xl border bg-white p-12 text-center shadow dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <p className="mt-4 text-lg text-gray-500">
              Save products you love and compare them later before making your
              purchase.
            </p>
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-bold">My Wishlist</h1>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl bg-white p-6 shadow dark:bg-zinc-900">
            <div className="text-sm text-gray-500">Saved Products</div>
          ...
          <div className="rounded-2xl bg-white p-6 shadow dark:bg-zinc-900">
            <div className="text-sm text-gray-500">Wishlist Status</div>
            <div className="mt-3 text-2xl font-bold text-green-600">Active</div>
          </div>

          <div className="rounded-2xl bg-white p-6 shadow dark:bg-zinc-900">
            <div className="text-sm text-gray-500">Ready to Compare</div>
            <div className="mt-3 text-2xl font-bold text-orange-600">Yes</div>
          </div>
        </div>
