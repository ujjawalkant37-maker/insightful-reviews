...
export const metadata = { title: "Best Smartphones Under \u20b920,000 | Insightful Reviews" };

export default function GuidePage() {
  const points = ["Compare processor performance and sustained performance.", "Prioritise display quality, battery and charging.", "Check camera consistency rather than megapixel count alone.", "Check software support and after-sales service.", "Compare current street price before buying."];
  return (
    <main className="container max-w-4xl py-12">
      <Link href="/guides" className="text-sm font-semibold text-indigo-600">← All guides</Link>
      <h1 className="mt-6 text-4xl font-bold">Best Smartphones Under ₹20,000</h1>
