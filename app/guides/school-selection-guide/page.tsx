...
export const metadata = { title: "How to Choose a School | Insightful Reviews" };

export default function GuidePage() {
  const points = ["Check curriculum and recognition.", "Compare total fees and commute.", "Evaluate student support, safety and facilities.", "Assess fit for the child's learning needs.", "Verify current admission criteria with the school."];
  return (
    <main className="container max-w-4xl py-12">
      <Link href="/guides" className="text-sm font-semibold text-indigo-600">← All guides</Link>
      <h1 className="mt-6 text-4xl font-bold">How to Choose a School</h1>
