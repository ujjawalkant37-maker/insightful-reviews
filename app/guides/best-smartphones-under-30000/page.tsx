...
export const metadata = { title: "Best Smartphones Under \u20b930,000 | Insightful Reviews" };

export default function GuidePage() {
  const points = ["Compare processor, display brightness and camera stabilisation.", "Check software support and warranty.", "Consider storage and service network.", "Use current price rather than launch price.", "Read long-term user feedback."];
  return (
    <main className="container max-w-4xl py-12">
      <Link href="/guides" className="text-sm font-semibold text-indigo-600">← All guides</Link>
      <h1 className="mt-6 text-4xl font-bold">Best Smartphones Under ₹30,000</h1>
